...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-010-0116-questions-in-geometric-group-theory-q-94523c98",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-010-0116-5a841ac518c5",
        "url": "https://www.unsolvedmath.com/problems/AMR-010-0116"
      }
    ],
    "statement": {
      "language": "en",
      "text": "(Dani Wise) Let $G^n$ denote the Cartesian product of $n$ copies of $G$, and let $\\operatorname{rank}(G^n)$ be its smallest number of generators. If $G$ is word-hyperbolic, is $\\lim_{n\\to\\infty}\\operatorname{rank}(G^n)=\\infty$?",
      "version": 1
    },
    "title": "Questions in Geometric Group Theory — Q 1.16",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "6b5ba5ac97d3cb0c306667f747e8d90a1fb78ba0aa415a7e199c74be7c1f70c6"
}
```
